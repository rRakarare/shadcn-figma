...
function Separator({ className, horizontal = "False" }: SeparatorProps) {
  return (
    <div data-node-id="2232:5629" className={className || "content-stretch flex flex-col gap-[var(--p-0,0px)] h-[24px] items-start p-[var(--p-0,0px)] relative w-0"}>
        ...
        <div className="-rotate-90 flex-none h-full">
          <div data-node-id="2232:5631" className="h-full relative w-[24px]" data-name="Line">
            <div className="absolute inset-[-1px_0_0_0]">
              <img className="block max-w-none size-full" alt="" src="" />
            </div>
          </div>
        </div>
      </div>
